...
<div className=' Creators'>
            ...
            <div className='RO-CreatorCards'>
                <div>
                    <CardRealCreators image={PenaImg} name="Eleanor Pena" career="UI Designer" path="#"></CardRealCreators>
                </div>
                <div className='RO-Card2'>
                    <CardRealCreators image={cameronImg} name="Cameron Williamson" career="UX Designer" path="#" />
                </div>
                <div>
                    <CardRealCreators image={floydImg} name="Floyd Miles" career="Programmer" path="#" />
                </div>
                <div className='RO-Card2'>
                    <CardRealCreators image={krisImg} name="Kristin Watson" career="UX/UI Designer" path="#" />
                </div>
            </div>
        </div>
    </div>
